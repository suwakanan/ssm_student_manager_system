				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${courseList}" var="item">
								<tr>
									...
									<td><c:forEach  items="${teacherList}" var="teacheritem"><c:if test="${item.teacherid == teacheritem.userid}">${teacheritem.username}</c:if></c:forEach></td>
									...
									<td>${item.score}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='/teacher/gradeCourse?id=${item.courseid}'">课程评分</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
